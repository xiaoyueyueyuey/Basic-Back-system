package com.xy.infrastructure.exception;


import com.xy.common.base.BaseResponseData;
import com.xy.common.exception.ApiException;
import com.xy.common.exception.error.ErrorCode.Business;
import com.xy.common.exception.error.ErrorCode.Client;
import com.xy.common.exception.error.ErrorCode.Internal;
...
public class GlobalExceptionInterceptor {
    ...
    public BaseResponseData<?> handleAccessDeniedException(AccessDeniedException e, HttpServletRequest request) {
        ...
        return BaseResponseData.fail(new ApiException(Business.PERMISSION_NOT_ALLOWED_TO_OPERATE));
    }
    ...
    public BaseResponseData<?> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException e,
        ...
        return BaseResponseData.fail(new ApiException(Client.COMMON_REQUEST_METHOD_INVALID, e.getMethod()));
    }
    ...
    public BaseResponseData<?> handleServiceException(UncheckedExecutionException e) {
        log.error(e.getMessage(), e);
        return BaseResponseData.fail(new ApiException(Internal.GET_CACHE_FAILED, e.getMessage()));
    }
    ...
    public BaseResponseData<?> handleRuntimeException(RuntimeException e, HttpServletRequest request) {
        ...
        return BaseResponseData.fail(new ApiException(Internal.INTERNAL_ERROR, e.getMessage()));
    }
    ...
    public BaseResponseData<?> handleBindException(BindException e) {
        ...
        return BaseResponseData.fail(new ApiException(Client.COMMON_REQUEST_PARAMETERS_INVALID, message));
    }
